...
country = {
	...
	PROVINCE_OVERSEAS_PENALTY = 0.033, -- Each province req. this many goods flagged as overseas penalty
	...
	RESEARCH_POINTS_ON_CONQUER_MULT = 250, -- multiplier to RP got by conquering as unciv when got enacted military reforms
...
diplomacy = {
	...
	INFAMY_RELEASE_PUPPET = 0.25,
	INFAMY_MAKE_PUPPET = 2.5,
	INFAMY_DISARMAMENT = 2.5,
	INFAMY_DESTROY_FORTS = 1,
	INFAMY_DESTROY_NAVAL_BASES = 1,
	INFAMY_REPARATIONS = 2.5,
	INFAMY_TRANSFER_PROVINCES = 2.5,
	INFAMY_REMOVE_CORES = 0,
	INFAMY_PRESTIGE = 1,
	INFAMY_CONCEDE = 0.5,
	INFAMY_STATUS_QUO = 0,
	INFAMY_ANNEX = 5,
	INFAMY_DEMAND_STATE = 2.5,
	INFAMY_INSTALL_COMMUNIST_GOV_TYPE = 2.5,
	INFAMY_UNINSTALL_COMMUNIST_GOV_TYPE = 2.5,
	INFAMY_COLONY = 0,
	...
	CB_DETECTION_CHANCE_BASE = 500, -- chance out of 1000 every day
	...
	CRISIS_WARGOAL_INFAMY_MULT = 0.5, -- Applied to all infamy from adding wargoals in a crisis
